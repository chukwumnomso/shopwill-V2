...
const OrderSummary = () => {
  ...
  return (
    <>
      ...
      {cart > 0 && (
        <div>
          <div className="  px-4 pt-4 text-gray-800 h-50 bg-whiteshadow-neutral-800 shadow-2xl font-[jost]">
            ...
            <div className="flex gap-4 mt-4">
              <button className="bg-black text-white w-full py-2 uppercase hover:bg-gray-800 hover:scale-101 transition-all duration-300 cursor-pointer ">
                checkout
              </button>
            </div>
          </div>
